...
/**
 * @see org.zanata.rest.dto.resource.AbstractResourceMeta
 * @see org.zanata.rest.dto.resource.Resource
 * @see org.zanata.rest.dto.resource.ResourceMeta
 * @see org.zanata.rest.dto.resource.TranslationsResource
 *
 */
@Entity
...
public class HDocument extends ModelEntityBase implements DocumentWithId, IDocumentHistory, Serializable, Iterable<ITextFlow>, IsEntityWithType
{
   ...
   @Override
   public @Nonnull
   org.zanata.common.LocaleId getSourceLocaleId()
   {
